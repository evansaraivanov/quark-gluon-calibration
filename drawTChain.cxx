...
TFile *f = new TFile("/eos/user/e/esaraiva/dijet-data-bdt/dijet_pythia_bdt.root","recreate");
//TFile *f = new TFile("/eos/user/w/wasu/AQT_dijet_data_bdt/dijet_data_bdt.root","recreate");

string root_lists = "/eos/user/e/esaraiva/dijet-data-bdt/dijet_pythia_bdt.txt";
