...
file1 = TFile("dijet_sherpa_py.root")
file2 = TFile("dijet-sherpa-eta-newrange.root")

bin = np.array([500.,600.,800.,1000.,1200.,1500.,2000.])
bin2 = np.array([0.0,0.5,1.0,1.5,2.1])
...
eta_higher_quark = TH1F("eta_higher_quark","",4,bin2)
eta_higher_gluon = TH1F("eta_higher_gluon","",4,bin2)
eta_lower_quark = TH1F("eta_lower","",4,bin2)
eta_lower_gluon = TH1F("eta_lower_gluon","",4,bin2)
...
leg1.AddEntry(pt_higher_quark,"f_{q}^{1}","l")
leg1.AddEntry(pt_higher_gluon,"f_{g}^{1}","l")
leg1.AddEntry(pt_lower_quark,"f_{q}^{2}","l")
leg1.AddEntry(pt_lower_gluon,"f_{g}^{2}","l")
...
eta_higher_quark.GetYaxis().SetTitle("Parton Fraction")
...
leg1 = TLegend(.15,0.15,0.45,0.3)
leg1.AddEntry(eta_higher_quark,"f_{q}^{1}","l")
leg1.AddEntry(eta_higher_gluon,"f_{g}^{1}","l")
leg1.AddEntry(eta_lower_quark,"f_{q}^{2}","l")
leg1.AddEntry(eta_lower_gluon,"f_{g}^{2}","l")
leg1.SetBorderSize(0)
leg1.SetFillStyle(0)
