...
#        print("made graph for "+var1)
    ...
    c1.Print("./roc-plots/leading/"+str(bin[i])+"-"+str(bin[i+1])+"-higher-leading-ROC-plots.pdf")
    ...
    c1.Print("./roc-plots/leading/"+str(bin[i])+"-"+str(bin[i+1])+"-lower-leading-ROC-plots.pdf")
